...
public class EditPartyActivity extends AppCompatActivity implements EditPartyActivityContract.view {
    ...
    private EditPartyActivityPresenter presenter;
    private Party party;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onCreate: " + party.getId());
        if(party != null){
            mEtPartyName.setText(party.getPartyName());
            mEtPartyAddress.setText(party.getAddress());
            mEtPartyDescription.setText(party.getDescription());
            mEtDate.setText(party.getDate());
            mEtStartTime.setText(party.getStartTime());
            mEtEndDate.setText(party.getEndDate());
        ...
        //set up presenter
        presenter = new EditPartyActivityPresenter();
        ...
        mIvStartGallery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    if (ActivityCompat.checkSelfPermission(EditPartyActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(EditPartyActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE}, PICK_FROM_GALLERY);
                    } else {
