...
public class AdapterPeopleInfo extends RecyclerView.Adapter<AdapterPeopleInfo.ViewHolder> {
    ...
    public AdapterPeopleInfo(List<String> idsList, List<String> usernameList, List<String> alreadyFriendsList, FriendsActivityContract.view view, Context context) {
